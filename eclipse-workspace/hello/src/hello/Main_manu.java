...
public class Main_manu {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Main_manu window = new Main_manu();
	...
	private void initialize() {
		...
		lblNewLabel_2.setBounds(41, 11, 126, 103);
		panel_1.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Member Info");
		lblNewLabel_3.setFont(new Font("Times New Roman", Font.BOLD, 15));
		lblNewLabel_3.setForeground(Color.BLACK);
		lblNewLabel_3.setBounds(65, 114, 91, 25);
		panel_1.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\Shubham\\eclipse-workspace\\mess_management\\alldocument\\1234.png"));
		lblNewLabel_4.setBounds(55, 161, 98, 120);
		panel_1.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("Show All Detail");
		lblNewLabel_5.setFont(new Font("Times New Roman", Font.BOLD, 15));
		lblNewLabel_5.setForeground(Color.BLACK);
		lblNewLabel_5.setBounds(55, 281, 102, 25);
		panel_1.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("");
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\Shubham\\eclipse-workspace\\mess_management\\alldocument\\12.png"));
		lblNewLabel_6.setBounds(41, 317, 102, 103);
		panel_1.add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("Book Thali");
		lblNewLabel_7.setFont(new Font("Times New Roman", Font.BOLD, 15));
		lblNewLabel_7.setForeground(Color.BLACK);
		lblNewLabel_7.setBounds(65, 414, 91, 25);
